const cards = [
    { front: 'Лингводидактика', back: 'прикладная лингвистическая дисциплина, рассматривающая как обучение иностранному языку, так и усвоение иностранного языка', isDefinitionCorrect: true },
    { front: 'Универсалии языка', back: 'свойства, присущие человеческому языку в целом (всем или подавляющему большинству естественных языков)', isDefinitionCorrect: true },
    { front: 'Трансформационная грамматика', back: 'теория, разработанная Ноамом Хомским в 1950-х годах, объясняющая, как конечное число языковых правил порождает бесконечное множество предложений', isDefinitionCorrect: true }
];
