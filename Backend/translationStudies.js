const cards = [
    {
        front: 'Перевод',
        back: 'процесс и результат преобразования текста на одном языке в текст на другом при сохранении содержания, стиля и функции',
        isDefinitionCorrect: true
    },
    {
        front: 'Текст оригинала',
        back: 'исходное сообщение, подлежащее переводу',
        isDefinitionCorrect: true
    },
    {
        front: 'Переводоведение',
        back: 'это гуманитарная дисциплина на стыке лингвистики, литературоведения, теории коммуникации и социологии, изучающая процесс, результаты и закономерности устного и письменного перевода',
        isDefinitionCorrect: true
    },
    {
        front: 'Исходный язык (ИЯ)',
        back: 'язык оригинала, с которого выполняется перевод',
        isDefinitionCorrect: true
    },
    {
        front: 'Переводящий язык (ПЯ)',
        back: 'язык, на который выполняется перевод',
        isDefinitionCorrect: true
    },
    {
        front: 'Текст перевода',
        back: 'результат переводческой деятельности',
        isDefinitionCorrect: true
    }
];
...
function handleAnswer(answerType) {
    ...
    showToast(isCorrectAnswer ? 'Верно!' : 'Ошибка!');
    cardElement.classList.remove('is-flipped');
}
